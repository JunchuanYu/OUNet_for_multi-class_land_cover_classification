...
from tensorflow.keras.layers import Input, Concatenate, Conv2D, MaxPooling2D, UpSampling2D,BatchNormalization,ZeroPadding2D,add, multiply,Conv2DTranspose,Flatten,Activation,AveragePooling2D,Dense,SeparableConv2D,GlobalAveragePooling2D
