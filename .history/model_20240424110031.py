...
from tensorflow.keras.layers import Input, Concatenate, Conv2D, MaxPooling2D, UpSampling2D,BatchNormalization,Activation,AveragePooling2D,Dense,SeparableConv2D,GlobalAveragePooling2D
